...
const details = {
  ...
  qampus: { stack:["Mobile UX","Location context","Product design","Research"], impact:["Campus discovery","Context-aware experience","Student-first flows"], decisions:["Surface information in the moment","Prioritise campus context","Design for quick mobile decisions"] },
  ...
  "dpp-converter": { stack:["Automation","Structured JSON","Document generation","Full-stack"], impact:["Manual work reduced","Repeatable output","Education operations"], decisions:["Preserve question structure","Validate before export","Make the workflow reusable"] },
